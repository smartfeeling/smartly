...
public final class OptRuntime extends ScriptRuntime
{
    ...
    {
        return fun.call(cx, scope, thisObj, emptyArgs);
    }
                                   ...
                                   Context cx, Scriptable scope)
    {
        Callable f = getNameFunctionAndThis(name, cx, scope);
        Scriptable thisObj = lastStoredScriptable(cx);
        return f.call(cx, scope, thisObj, emptyArgs);
    }
    ...
    {
        return elemIncrDecr(obj, new Double(index), cx,
                                          incrDecrMask);
    }
    ...
    {
        initFunction(cx, scope, fn, functionType, false);
    }
    ...
    public static Object newObjectSpecial(Context cx, Object fun,
                                          ...
                                          Scriptable callerThis, int callType)
    {
        return newSpecial(cx, fun, args, scope, callType);
    }
