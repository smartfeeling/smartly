...
package old.mozilla.javascript.optimizer;

import old.mozilla.classfile.ByteCode;
import old.mozilla.classfile.ClassFileWriter;
import old.mozilla.javascript.*;
...
public class Codegen extends Interpreter
{
    ...
    private byte[] generateCode(String encodedSource)
    {
        ...
        if (hasScript) {
            cfw.addInterface("old/mozilla/javascript/Script");
...
*/
        ...
        cfw.addInvoke(ByteCode.INVOKEVIRTUAL,
                "old/mozilla/javascript/BaseFunction",
                      "createObject",
        ...
        cfw.add(ByteCode.INSTANCEOF, "old/mozilla/javascript/Scriptable");
        cfw.add(ByteCode.IFEQ, exitLabel);
        // cast direct call result
        cfw.add(ByteCode.CHECKCAST, "old/mozilla/javascript/Scriptable");
    ...
    private void generateCallMethod(ClassFileWriter cfw)
    {
        ...
        cfw.addALoad(1); //cx
        cfw.addInvoke(ByteCode.INVOKESTATIC,
                "old/mozilla/javascript/ScriptRuntime",
                      "hasTopCall",
                      "(Lorg/mozilla/javascript/Context;"
                      +")Z");
                                      ...
                                      OptFunctionNode ofn)
    {
        ...
        cfw.addALoad(SCOPE_ARG);
        cfw.addInvoke(ByteCode.INVOKEVIRTUAL,
                "old/mozilla/javascript/NativeFunction",
                      "initScriptFunction",
                      "(Lorg/mozilla/javascript/Context;"
                      +"Lorg/mozilla/javascript/Scriptable;"
                      +")V");
        ...
        for (int i = 0; i != scriptOrFnNodes.length; ++i) {
            ...
            for (int j = 0; j != regCount; ++j) {
                ...
                cfw.addInvoke(ByteCode.INVOKEINTERFACE,
                        "old/mozilla/javascript/RegExpProxy",
                              "compileRegExp",
                              "(Lorg/mozilla/javascript/Context;"
        ...
        if (num == 0.0) {
            if (1 / num > 0) {
                ...
                cfw.add(ByteCode.GETSTATIC,
                        "old/mozilla/javascript/optimizer/OptRuntime",
    ...
    {
        cfw.add(ByteCode.GETSTATIC, "old/mozilla/javascript/Undefined",
...
class BodyCodegen
{
    ...
    private void generatePrologue()
    {
                ...
                || fnCurrent.fnode.getIgnoreDynamicScope()))
        {
            ...
            cfw.addInvoke(ByteCode.INVOKEINTERFACE,
                    "old/mozilla/javascript/Scriptable",
                          "getParentScope",
                          "()Lorg/mozilla/javascript/Scriptable;");
        ...
        switch (type) {
              ...
              case Token.THROW:
                ...
                cfw.add(ByteCode.NEW,
                        "old/mozilla/javascript/JavaScriptException");
...
*/
        ...
        if (type == Token.NEW) {
            ...
            cfw.addInvoke(ByteCode.INVOKEINTERFACE,
                    "old/mozilla/javascript/Callable",
                "call",
                "(Lorg/mozilla/javascript/Context;"
                +"Lorg/mozilla/javascript/Scriptable;"
                +"Lorg/mozilla/javascript/Scriptable;"
                                    ...
                                    int exceptionLocal)
    {
        ...
        if (exceptionType == JAVASCRIPT_EXCEPTION) {
            exceptionName = "old/mozilla/javascript/JavaScriptException";
        } else if (exceptionType == EVALUATOR_EXCEPTION) {
            exceptionName = "old/mozilla/javascript/EvaluatorException";
        } else {
            if (exceptionType != ECMAERROR_EXCEPTION) Kit.codeBug();
            exceptionName = "old/mozilla/javascript/EcmaError";
        }
