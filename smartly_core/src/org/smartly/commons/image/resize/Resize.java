...
public class Resize {
    ...
    public static BufferedImage resize(BufferedImage src, Method scalingMethod,
        ...
        if (scalingMethod == Resize.Method.AUTOMATIC)
        ...
        if (scalingMethod == Resize.Method.SPEED) {
            result = scaleImage(src, targetWidth, targetHeight,
                    RenderingHints.VALUE_INTERPOLATION_NEAREST_NEIGHBOR);
        } else if (scalingMethod == Resize.Method.BALANCED) {
            result = scaleImage(src, targetWidth, targetHeight,
                    RenderingHints.VALUE_INTERPOLATION_BILINEAR);
        } else if (scalingMethod == Resize.Method.QUALITY
                || scalingMethod == Resize.Method.ULTRA_QUALITY) {
			/*
